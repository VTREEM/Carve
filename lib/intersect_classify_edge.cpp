...
namespace carve {
  namespace csg {
    ...
    namespace {
      ...
      typedef std::pair<size_t, const carve::poly::Vertex *> PerimKey;
      ...
      typedef std::unordered_map<std::pair<size_t, const carve::poly::Vertex *>,
      ...
      static inline void remove(const carve::poly::Vertex *a, const carve::poly::Vertex *b, VVSMap &shared_edge_graph) {
      ...
      static inline void remove(V2 edge, VVSMap &shared_edge_graph) {
      ...
      static void walkGraphSegment(VVSMap &shared_edge_graph,
        ...
        while (1) {
          ...
          VVSMap::const_iterator o = shared_edge_graph.find(curr.second);
        ...
        if (!closed) {
          ...
          while (1) {
            ...
            VVSMap::const_iterator o = shared_edge_graph.find(curr.first);
            if (o == shared_edge_graph.end()) break;
      ...
      static void traceIntersectionGraph(const V2Set &shared_edges,
        ...
        for (V2Set::const_iterator i = shared_edges.begin(); i != shared_edges.end(); ++i) {
          ...
          VVSMap::mapped_type &out = (shared_edge_graph[edge.first]);
        ...
        while (shared_edge_graph.size()) {
          ...
          const carve::poly::Vertex *v1 = (*i).first;
          const carve::poly::Vertex *v2 = *((*i).second.begin());
      ...
      void hashByPerimeter(FLGroupList &grp, PerimMap &perim_map) {
        for (FLGroupList::iterator i = grp.begin(); i != grp.end(); ++i) {
          ...
          const carve::poly::Vertex *perim_min = std::min_element((*i).perimeter.begin(), (*i).perimeter.end())->first;
...
#endif
          const carve::poly::Vertex *p = (*i).face_loops.head->vertices[0];
