...
namespace carve {
  namespace csg {
    ...
    struct FaceLoop {
      ...
      FaceLoop(const carve::poly::Face *f, const std::vector<const carve::poly::Vertex *> &v) : next(NULL), prev(NULL), orig_face(f), vertices(v), group(NULL) {}
    };
    ...
    typedef std::unordered_map<const carve::poly::Vertex *, std::list<FaceLoop *>, carve::poly::hash_vertex_ptr> LoopLookup;
    typedef std::unordered_map<const carve::poly::Vertex *, std::list<FLGroupList::iterator>, carve::poly::hash_vertex_ptr> GroupLookup;
